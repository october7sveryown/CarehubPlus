...
<head>
    ...
    <title>Carehub+ | Admin Panel</title>
...
<!--php code-->
    ...
    <?php 
              ...
              if(isset($error) && $error!='' ){  ?>
                <div class="alert alert-danger" style="margin-top:5%";margin-left:18%;>
        ...
        <?php if(isset($message)){  ?><div class='alert alert-success' style="margin-top:5%;margin-left:18%;">
                    <?php  echo $message;   ?>
                </div>
                <?php } ?> 
...
<!-->
        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item"><a href="<?php echo base_url() ;?>home/staff_home" class="navbar-brand nav-link"><img alt="branding logo" src="<?php echo base_url();?>/assets/images/Carehub.png" data-expand="<?php echo base_url();?>assets/images/CareHub.png" data-collapse="<?php echo base_url();?>/assets/images/NavLog.png" class="brand-logo"></a></li>
            ...
            <div class="navbar-container content container-fluid">
                <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                    ...
                    <!--    <li class="dropdown dropdown-language nav-item"><a id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle nav-link"><i class="flag-icon flag-icon-gb"></i><span class="selected-language">English</span></a>
                            <div aria-labelledby="dropdown-flag" class="dropdown-menu"><a href="#" class="dropdown-item"><i class="flag-icon flag-icon-gb"></i> English</a><a href="#" class="dropdown-item"><i class="flag-icon flag-icon-fr"></i> French</a><a href="#" class="dropdown-item"><i class="flag-icon flag-icon-cn"></i> Chinese</a>
                                <a
                                  href="#" class="dropdown-item"><i class="flag-icon flag-icon-de"></i> German</a>
                            </div>
                        </li>
                    ...
                    --> <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link" style="margin-top:0px;font-size:15px;"><b><span class="user-name"><?php echo $this->session->userdata('name');?></span></b></a>


                            <div class="dropdown-menu dropdown-menu-right"><a href="<?php echo site_url('home/edit_staff');?>" class="dropdown-item"><i class="icon-head"></i> Edit Profile</a>
                                <div class="dropdown-divider"></div><a href="<?php echo site_url('login/logout'); ?>" class="dropdown-item"><i class="icon-power3"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    --> <!-- / main menu header-->
        ...
        <div class="main-menu-content" >
            <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main active" >
                <li class="nav-item"><a href="<?php echo base_url();?>home/staff_home"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Home</span></a>
            ...
            --> </li>
                <li class="nav-item"><a href="<?php echo base_url();?>Patient/add_patient"><i class="icon-plus-circle"></i><span data-i18n="nav.page_layouts.main" class="menu-title">Add Patient</span></a>
            <!--        <ul class="menu-content">
                        <li><a href="<?php echo base_url();?>addPatient/" data-i18n="nav.page_layouts.1_column" class="menu-item"><i class="fa fa-plus-square" aria-hidden="true"></i>Add patient</a>
                        </li>
            ...
            --> </li>
         <!--       <li class=" nav-item"><a href="<?php echo base_url();?>"><i class="icon-pencil-square-o"></i><span data-i18n="nav.project.main" class="menu-title">Edit patient</span></a></li>
          -->  <!--        <ul class="menu-content">
            ...
            --> <li class=" nav-item"><a href="<?php echo base_url();?>Patient/"><i class="icon-list-alt"></i><span data-i18n="nav.cards.main" class="menu-title">View Patient</span></a>
            <!--        <ul class="menu-content">
        ...
        <!--            <ul class="menu-content">
            ...
            --> </li>
              <li class=" nav-item"><a href="<?php echo base_url();?>Patient/Diseases"><i class="icon-envelope"></i><span data-i18n="nav.components.main" class="menu-title">Diseases</span></a>
              </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Patient/sendsms"><i class="icon-envelope"></i><span data-i18n="nav.components.main" class="menu-title">Send SMS</span></a>
        <!--            <ul class="menu-content">
            ...
            --> </li>
             <!--   <li class=" nav-item"><a href=""><i class="icon-print"></i><span data-i18n="nav.icons.main" class="menu-title">Print</span></a>
                    <ul class="menu-content">
                        <li><a href="icons-feather.html" data-i18n="nav.icons.icons_feather" class="menu-item">Patient Report</a>
                        </li>
                        <li><a href="icons-ionicons.html" data-i18n="nav.icons.icons_ionicons" class="menu-item">Invoice</a>
                        </li>
            ...
            --><li class=" nav-item"><a href="<?php echo base_url();?>login/logout"><i class="icon-sign-out"></i><span data-i18n="nav.form_layouts.form_layout_basic" class="menu-title">Logout</span></a>
                </li>
