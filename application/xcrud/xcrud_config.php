...
{
    // default connection
    public static $dbname = 'carehubplus'; // Your database name
    ...
    public static $dbprefix = 'carehub_';
    ...
    //public static $editor_init_url = 'editors/tinymce/tinymce.min.js'; //  URL path to your custom initialization file for editor.
    public static $editor_init_url = 'http://tinymce.cachefly.net/4.1/tinymce.min.js';
    public static $editor_url = 'http://tinymce.cachefly.net/4.1/tinymce.min.js';
    ...
    public static $date_format = 'mm-dd-yy'; // jqueryui date format
    public static $time_format = 'HH:mm:ss'; // jqueryui time format
    public static $php_date_format = 'm-d-Y'; // php date format
